...
| `--image` | | Container image used for benchmark job | `rolebasedgroup-registry.cn-beijing.cr.aliyuncs.com/rolebasedgroup/rbgs-benchmark-tool-genai:v0.1.0` |
...
| `--image` | | Container image for the benchmark dashboard | `rolebasedgroup-registry.cn-beijing.cr.aliyuncs.com/rolebasedgroup/rbgs-benchmark-dashboard:v0.1.0` |
